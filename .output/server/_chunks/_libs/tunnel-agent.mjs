...
import { r as requireSafeBuffer } from "../../_libs/safe-buffer.mjs";
...
function requireTunnelAgent() {
  ...
  var tls = require$$1$2, http = require$$1, https = require$$2, events = require$$0, assert = require$$4, util = require$$1$1, Buffer = requireSafeBuffer().Buffer;
...
var tunnelAgentExports = /* @__PURE__ */ requireTunnelAgent();
