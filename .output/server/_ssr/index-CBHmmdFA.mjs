...
import { C as ContentPage } from "./ContentPage-BmiFMXe2.mjs";
import { m as Route } from "./router-BcETx6jF.mjs";
import "../_chunks/_libs/@portabletext/react.mjs";
import "../_chunks/_libs/@portabletext/toolkit.mjs";
import "../_libs/react-player.mjs";
...
import "./GrainyBackground-CUqq47fm.mjs";
...
function CreativeCornerContent() {
  const creativeContentPost = Route.useLoaderData();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ContentPage, { content: creativeContentPost });
}
export {
  CreativeCornerContent as component
};
