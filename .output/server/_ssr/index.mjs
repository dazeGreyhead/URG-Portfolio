...
import { w as defineHandlerCallback } from "../_chunks/_libs/@tanstack/router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-moP9Eug2.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-BcETx6jF.mjs").then((n2) => n2.r);
