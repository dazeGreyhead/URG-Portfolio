...
import { l as Route$1 } from "./router-BI5_5ib4.mjs";
...
function PortfolioProject() {
  const portfolioProject = Route$1.useLoaderData();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ContentPage, { content: portfolioProject });
}
export {
  PortfolioProject as component
};
